...
tab1=rbind(
  ...
  rouder.lexdec,
  rouder.orient)
tab0=cbind(tab1[,c(7,6)],tab1[,7]/(2*tab1[,6]),tab1[,8],tab1[,9],tab1[,1]*1000,tab1[,10]*1000,tab1[,2]*1000,tab1[,4]*1000)
...
apa_table(tab
          ...
          , col_spanners = list("Sample Sizes" = c(2, 4), "Reliability" = c(5, 6),"Sample"=c(7,8),"Parameters"=c(9,10))
          , stub_indents = list("Stroop" = 1:6, "Simon" = 7:9, "Flanker" = 10:13,"Other"=14:15)
          , escape = F
          ,midrules=19
...
spearman.cor=true.cor=observed.cor=mod.cor=1:R
for (r in 1:R){
...
save(file='alodie4dat.RData',dat,mod)
```
...
rel=split=1:R
for (r in 1:R){
  dat=sim1(typical)$dat
  rel[r]=reliability(dat)
  split[r]=split.rel(dat)}
```
